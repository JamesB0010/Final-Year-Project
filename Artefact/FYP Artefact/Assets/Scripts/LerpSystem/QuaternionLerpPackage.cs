...
public class QuaternionLerpPackage : LerpPackage
{
    ...
    public QuaternionLerpPackage(Quaternion start, Quaternion target, Action<Quaternion> stepCallback,
        Action<LerpPackage> finalCb, float timeToLerp = 1.0f, AnimationCurve animCurve = null) : base(finalCb, timeToLerp, animCurve)
    {
        this._start = start;
        this._target = target;
